                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('pelanggan.store') }}" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">CODE
                                                            AREA</label>
                                                        {{-- <fieldset disabled="disabled"> --}}
                                                        <select class="form-select form-select-sm" id="area_kedua"
                                                            disabled>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1"
                                                            class="form-label">ODP_LOC</label>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($pelanggans as $pelanggan)
                                        <tr>
                                            ...
                                            <td>{{ $pelanggan->nama }} ({{ $pelanggan->kontak }}) <br>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    ...
                                                    @foreach ($pelanggan->fotos as $foto)
                                                        ...
                                                        // Keluar dari perulangan setelah menemukan 'NOK'
                                                    ...
                                                    // Keluar dari perulangan setelah menemukan 'OK'
                                                @endif
                                            @endforeach
