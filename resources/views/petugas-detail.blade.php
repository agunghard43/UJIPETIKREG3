                                        ...
                                        <table class="table-condensed">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        ODP-{{ $pelanggans->area }}/{{ $pelanggans->odp_loc }} </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    @endif --}}
                                                <div class="validator">
                                                    ...
                                                    <th style="font-size: 14px" width="1%">Pastikan mengisinya
                                                        berurutan !</th>
                                                </div>
                                                <!-- kolom 1 -->
                                                <div class="kolom 1">
                                              ...
                                              ">
                                                ...
                                                <div class="kolom 2">
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: middle !important;font-size:12px;"
                                                            width="1%">5. Tidak ada penarikan dropcore di atas 50
                                                            m tanpa tiang
