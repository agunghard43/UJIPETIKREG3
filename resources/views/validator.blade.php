                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <ul class="nav nav-pills chart-header-tab mb-3" id="pills-tab"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a href="#" class="nav-link chart-nav active"
                                                        id="pills-validasi-tab" data-bs-toggle="pill"
                                                        data-bs-target="#pills-validasi" type="button" role="tab"
                                                        aria-controls="pills-validasi" aria-selected="true">
                                                        Validator
                                                    </a>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <a href="#" class="nav-link chart-nav" id="pills-reopen-tab"
                                                        data-bs-toggle="pill" data-bs-target="#pills-reopen"
                                                        type="button" role="tab" aria-controls="pills-reopen"
                                                        aria-selected="false">
                                                        Re-open
                                                    </a>
                                                </li>
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="table-responsive tab-pane fade show active"
                                                    id="pills-validasi" role="tabpanel"
                                                    aria-labelledby="pills-validasi-tab">
                                                        ...
                                                        @foreach ($pelangganFoto as $pelanggan)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @endforeach <br>
                                                                    <span
                                                                        class="label">{{ $pelanggan->area }}</span>
                                                                </td>
                                                                <td>SC.{{ $pelanggan->number }}
                                                                    <small>(/{{ $pelanggan->inet }})</small><br>
                                                                    <span class="label-sales">NEW SALES</span>
                                                                    <span
                                                                        class="label-tanggal">{{ $pelanggan->created_at_formatted }}</span>
                                                                </td>
                                                                <td>{{ $pelanggan->nama }}
                                                                    ({{ $pelanggan->kontak }}) <br>
                                                                    {{ $pelanggan->location }}</td>
                                                                <td>ODP-{{ $pelanggan->area }}/{{ $pelanggan->odp_loc }}
                                                                </td>
                                                                ...
                                                                <td>
                                                                    @if (session('bukti_dicek_' . $pelanggan->id))
                                                                        Bukti Sudah Dicek
                                                                    @else
                                                                        <a class="cek-bukti-link"
                                                                            href="/validator/cek/{{ $pelanggan->id }}">Cek
                                                                            Bukti</a>
                                                                    @endif
                                                                </td>
                                                            </tr>
                                            ...
                                            <div class="tab-pane fade" id="pills-reopen" role="tabpanel"
                                                aria-labelledby="pills-reopen-tab">
                                                <table id="example" class="table table-striped table-hover">
                                                    <thead>
                                                        <tr>
                                                            <td>NO</td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($hasilRevisi as $pelanggan)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a
                                                                        href="{{ route('validator.revisi', ['id' => $pelanggan->id]) }}">Cek
                                                                        Revisi</a>
                                                                </td>
