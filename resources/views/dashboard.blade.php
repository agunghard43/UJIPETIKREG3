                                ...
                                <form action="/" method="get">
                                    <div class="form-group">
                                        ...
                                        <div class="tombol">
                                            ...
                                            <a href="{{ route('export.excel', ['month' => $month, 'year' => $year]) }}"
                                            ...
                                            @else
                                                @foreach ($finalResults as $result)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">{{ $result['total_pelanggan'] }}
                                                        </td>
                                                        ...
                                                        <td style="text-align: center;">
                                                            {{ number_format($result['upload_percentage'], 0) }}%</td>
                                                        <td style="text-align: center;">
                                                            {{ number_format($result['valid_percentage'], 0) }}%</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                        </tbody>
